...
ctx.textBaseline = 'alphabetic';
  ...
  setTimeout(() => {
	...
	<container style="position:fixed;background-attachment:fixed;">
	 <main>
      <article class="card" aria-live="polite" style="position:relative;margin:auto;width:auto;display:flex;flex-direction:column;gap:20px;align-items:center;justify-content:center;text-align:center;font-family:sans-serif;animation:fadeInBg 0.3s ease forwards;">
       <h3 style="font-size:18px;color:002d5d;"><i class="fa fa-check" style="font-size:22px;color:#22c55e;"></i> Image Generated!</h3>
        ...
        <p style="width:100%;font-size:14px;opacity:0.5;color:#002d5d;align-items:center;justify-content:center;position:relative;animation:fadeInCard 0.3s ease forwards;">
          🔆 <b>Share</b> doesn’t work in some web systems<br>If notified, you can tap <b>save</b> instead.
        </p>
    ...
    fallback.innerHTML = `
      ...
      ">
        ...
        <p style="font-size:14px; opacity:0.8; margin-bottom: 15px;">
          ...
          Save the image and share manually.
        </p>
...
enableBtn.addEventListener("click", async () => {
  ...
  if (permission === "granted") {
    ...
    showNotifyModal("Daily reminders notification are enabled!");
  } else {
    showNotifyModal("Daily reminders are blocked, allow them in your system settings!");
  }
